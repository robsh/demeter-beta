...
$(document).ready(function () {
    ...
    var Landing = Parse.Object.extend("Beta")
    ...
    var saveItem = function(){
        ...
        landing.save(null, {
            success: function(landing) {
                ...
                $title.text('Thank you. We will email you with details of the beta.')
            },
                            ...
                            query.count({
                                success : function(count){
                                    if(count < 100){
                                        ...
                                        $flash.removeClass('hidden').html('Beta is full.')
                                        $button.html('Go!')
                                    }
                                },
                                error : function(){
                                    $flash.removeClass('hidden').html('An unknown error has occured.')
                                    $button.html('Go!')
                                }
                            })
